...
import protobuf.module.face_sys_pb2 as face__sys__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in face_sys_pb2_grpc.py depends on'
...
def add_RouteGuideServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetFacePosition': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=face__sys__pb2.ImagePair.FromString,
                    response_serializer=face__sys__pb2.Rectangle.SerializeToString,
            ),
    }
